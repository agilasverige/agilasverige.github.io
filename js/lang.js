...
const langArr = {
    ...
    "nextSpan11": {
        "sv": "19-20 maj 2025 blir det konferens igen på 7A Odenplan. Precis som vanligt kommer programmet att bestå av en blandning av blixttal, workshops och Open Space, med högt fokus på samtal och interaktivitet. Du hittar all info om konferensen och biljetter",
        "en": "The next conference will be May 19-20 2025 at the same spot, 7A Odenplan. As usual, we’ll offer a mix of lightning talks, workshops and open space sessions, with a focus on conversations and interactivity. You can find more info and tickets",
    ...
    "nextA31": {
        "sv": "Talanmälan för 2025 är redan igång!",
        "en": "Call for proposals 2025 is already open!",
        "uk": "звіт про виступ",
    },
    "nextSpan32": {
